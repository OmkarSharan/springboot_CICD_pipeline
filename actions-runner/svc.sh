...
SVC_NAME="actions.runner.OmkarSharan-springboot_CICD_pipeline.CICDPipeLineRunner"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (OmkarSharan-springboot_CICD_pipeline.CICDPipeLineRunner)"
